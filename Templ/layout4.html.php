...
<header>
        ...
        <div id="header" class="header1">
                <div class="hero-image">
                    <div class="logo-space">
                        <a class="brand" href="https://www.pegasoenvios.com" title="Pegaso home"
                ...
                <div class="topnav" id="myTopnav">
                        ...
                        <a class="underH" href="https://www.pegasoenvios.com">Pag. Principal</a>
    ...
    <div id="expandible" class="topnav-responsive">
        ...
        <div><a class="underH" href="https://www.pegasoenvios.com">Pag. Principal</a></div>
    </div>
</header>
