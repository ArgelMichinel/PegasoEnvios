...
<header>
	<div id="header" class="header">
        ...
        <div id="header" class="header1">
                ...
                <div class="topnav" id="myTopnav">
                        ...
                        <a class="underH" href="desk_client.php">Regr. al escritorio</a>
                        <a class="underH" href="pegaso_orders_client.php">Ordenes de envío</a>
                        <a class="underH" href="logg_packets.php">Orden de entrega</a>
    ...
    <div id="expandible" class="topnav-responsive">
        <div id="under8"><a class="underH" href="desk_client.php">Regr. al escritorio</a></div>
        <div id="under8"><a class="underH" href="pegaso_orders_client.php">Ordenes de envío</a></div>
        <div id="under8"><a class="underH" href="logg_packets.php">Orden de entrega</a></div>
