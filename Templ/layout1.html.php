...
<header>
	<div id="header" class="header">
        ...
        <div id="header" class="header1">
                ...
                <div class="topnav" id="myTopnav">
                        ...
                        <a class="underH" href="access_client.php"><i class="fa fa-user" aria-hidden="true"></i> Cliente</a>
    ...
    <div id="expandible" class="topnav-responsive">
        <div id="under5"><a class="underH" href="access_client.php"><i class="fa fa-user" aria-hidden="true"></i> Cliente</a></div>
    </div>
</header> 
